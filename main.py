...
def help():
    ...
    stdout.write("          "+Fore.LIGHTBLUE_EX   +"░█─── ▀█▀ █──█ █──█ ░█▄▄▄█ ─░█── \n")
    stdout.write("          "+Fore.LIGHTBLUE_EX   +"░█▄▄█ ▀▀▀ ▀▀▀▀ ▀──▀ ──░█── ─░█──\n")    
    stdout.write("             "+Fore.LIGHTRED_EX              +"          Author By LionGamingYT\n")
    stdout.write("                                                                                          \n")    
    ...
    stdout.write("    "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTCYAN_EX+"|"+Fore.LIGHTWHITE_EX+" Exit From Tools                        "+Fore.LIGHTCYAN_EX+"║\n")
    stdout.write("    "+Fore.LIGHTCYAN_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("    "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Author"+Fore.LIGHTCYAN_EX+"   |"+Fore.LIGHTWHITE_EX+" LionGamingYT"+Fore.LIGHTCYAN_EX+"                           ║\n")
    stdout.write("    "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Sourcode"+Fore.LIGHTCYAN_EX+" |"+Fore.LIGHTWHITE_EX+" -"+Fore.LIGHTCYAN_EX+"                                      ║\n")
    stdout.write("    "+Fore.LIGHTCYAN_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"My Web"+Fore.LIGHTCYAN_EX+"   |"+Fore.LIGHTWHITE_EX+" -"+Fore.LIGHTCYAN_EX+"                                      ║\n")
    stdout.write("    "+Fore.LIGHTCYAN_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def credit():
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╗\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Developer "+Fore.RED+": \x1b[38;2;0;255;189mSultanGanz\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"UI Design "+Fore.RED+": \x1b[38;2;0;255;189m𝙼𝚢 𝚂𝚎𝚕𝚏\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Methods   "+Fore.RED+": \x1b[38;2;0;255;189mZtN 404\n")
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
...
def title():
    ...
    stdout.write("                                                                                          \n")    
    stdout.write(""+Fore.LIGHTCYAN_EX+"╔════════════════════════════════════════════════════════════╗\n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Instagram : @liongamingyt_acc"+Fore.LIGHTCYAN_EX  +"                    ║  \n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"          Script Dont Not For Sale In Public"+Fore.LIGHTCYAN_EX +"               ║ \n")
    stdout.write(""+Fore.LIGHTCYAN_EX+"╚════════════════════════════════════════════════════════════╝ \n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTMAGENTA_EX+""+Fore.LIGHTGREEN_EX+"[""root"+Fore.LIGHTYELLOW_EX+"@"+Fore.LIGHTGREEN_EX+"LionYT"+Fore.CYAN+"]"+Fore.LIGHTMAGENTA_EX+"\n\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
